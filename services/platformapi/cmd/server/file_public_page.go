...
var fileShareTemplate = template.Must(template.New("fileshare").Funcs(template.FuncMap{
...
<script defer src="/assets/fileshare.js"></script>
</head>
<body>
  ...
  <div class="resourceWrap">
    ...
    <section class="resourceCard">
      ...
      <div class="resourceFooterActions">
        ...
        <a href="/reportabuse?url={{urlquery .SharePath}}">举报此文件</a>
      </div>
    </section>
  </div>
</main>
