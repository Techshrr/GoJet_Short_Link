...
func (s *server) registerEmailCodeRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/public/auth/google/start", noStoreHandler(sanitizeSocialRedirect(s.socialRegistrationStart(s.googleAuthStart))))
	mux.HandleFunc("GET /api/public/auth/google/callback", noStoreHandler(s.socialRegistrationCallbackRouter("google", s.socialCallbackRouter("google", s.googleAuthCallback))))
	mux.HandleFunc("GET /api/public/auth/facebook/start", noStoreHandler(sanitizeSocialRedirect(s.socialRegistrationStart(s.facebookAuthStart))))
	mux.HandleFunc("GET /api/public/auth/facebook/callback", noStoreHandler(s.socialRegistrationCallbackRouter("facebook", s.socialCallbackRouter("facebook", s.facebookAuthCallback))))
	mux.HandleFunc("GET /api/public/auth/github/start", noStoreHandler(sanitizeSocialRedirect(s.socialRegistrationStart(s.githubAuthStart))))
	mux.HandleFunc("GET /api/public/auth/github/callback", noStoreHandler(s.socialRegistrationCallbackRouter("github", s.socialCallbackRouter("github", s.githubAuthCallback))))
	mux.HandleFunc("GET /api/public/auth/qq/start", noStoreHandler(sanitizeSocialRedirect(s.socialRegistrationStart(s.qqAuthStart))))
	mux.HandleFunc("GET /api/public/auth/qq/callback", noStoreHandler(s.socialRegistrationCallbackRouter("qq", s.socialCallbackRouter("qq", s.qqAuthCallback))))
	mux.HandleFunc("GET /api/public/auth/wechat/start", noStoreHandler(sanitizeSocialRedirect(s.socialRegistrationStart(s.wechatAuthStart))))
	mux.HandleFunc("GET /api/public/auth/wechat/callback", noStoreHandler(s.socialRegistrationCallbackRouter("wechat", s.socialCallbackRouter("wechat", s.wechatAuthCallback))))
