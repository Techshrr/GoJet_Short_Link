...
mustContain("apps/workspace/src/routes/BillingPage.tsx", ["data-p13-billing", "Quota usage", "Orders & invoices", "Payment started", "not shown as paid until the server confirms it", "fx_provider", "fx_rate"]);
...
mustContain("../services/platformapi/cmd/server/billing.go", ["s.billing.Usage", "s.billing.PublicPlans", '"usage": usage']);
...
console.log("P13 Billing contract verified: real quota usage, public managed plans, non-optimistic payment truth, redacted callbacks, audited FX override, responsive Workspace/Admin commerce surfaces.");
