...
const AnalyticsPage = lazy(() => import("./routes/AnalyticsPageV503"));
const QRPage = lazy(() => import("./routes/QRPage"));
const FilesPage = lazy(() => import("./routes/FilesPageV503"));
const TextPage = lazy(() => import("./routes/TextPageV503"));
const BioPage = lazy(() => import("./routes/BioPageV503"));
const MembersPage = lazy(() => import("./routes/MembersPageV503"));
