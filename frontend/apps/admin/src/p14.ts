...
export type TicketAttachment={id:number;ticket_id:number;message_id:number;original_name:string;mime_type:string;size_bytes:number;scan_status:string;created_at:string;download_url?:string};
...
export const p14Client={
 ...
 attachments:(id:number)=>api.get<{data:TicketAttachment[]}>(`/api/admin/support/tickets/${id}/attachments`),
