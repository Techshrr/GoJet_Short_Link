...
const destinationRiskRoute = route("/destination-risk", DestinationRiskPage); const destinationRiskDetailRoute = route("/destination-risk/$riskId", DestinationRiskDetailPage); const fileSecurityRoute = route("/file-security", FileSecurityPage); const abuseRoute = route("/abuse", AbuseReportsPage); const securityEventsRoute = route("/security-events", SecurityEventsPage);
const ticketsRoute = route("/tickets", TicketsPage); const announcementsRoute = route("/announcements", AnnouncementsPage); const mailRoute = route("/mail", MailPage); const jobsRoute = route("/jobs", JobsPage); const servicesRoute = route("/services", ServicesPage);
