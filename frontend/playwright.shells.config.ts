...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: "pnpm --filter @gojet/docs exec astro dev --host 127.0.0.1 --port 4176", url: "http://127.0.0.1:4176/docs/en/", reuseExistingServer: !process.env.CI, timeout: 60_000 }
  ]
});
