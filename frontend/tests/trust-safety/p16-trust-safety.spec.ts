...
const fixtures: Record<string, unknown> = {
  ...
  "/api/admin/abuse": { data: [{ id: 12, link_id: 41, code: "launch", reporter: "reporter@example.com", reason: "phishing", details: "Suspicious credential collection page.", status: "open", created_at: "2026-08-18T12:00:00Z" }] },
