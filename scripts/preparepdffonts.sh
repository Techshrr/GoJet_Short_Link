...
FONT_SIZE='17773132'
UPSTREAM_FONT_NAME='NotoSansSC-VF.ttf'
FONT_URL="https://raw.githubusercontent.com/notofonts/noto-cjk/$NOTO_COMMIT/Sans/Variable/TTF/Subset/$UPSTREAM_FONT_NAME"
