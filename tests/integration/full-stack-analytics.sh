...
go build -o "$tmp/platform" ./services/platform-api/cmd/server
go build -o "$tmp/redirect" ./services/redirect-engine/cmd/server
go build -o "$tmp/worker" ./services/analytics-worker/cmd/worker
