...
go test -race -tags integration ./services/analyticsworker/internal/worker ./services/analyticsreconciler/internal/reconciler ./services/platformapi/cmd/server
