...
go vet ./...
npm run test:e2e
# Requires Redis, a MySQL-compatible server, clamd signatures and local ports:
...
Infrastructure acceptance and isolation guarantees are documented in
[`docs/integration-acceptance.zh-CN.md`](docs/integration-acceptance.zh-CN.md).
